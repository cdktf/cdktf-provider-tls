...
```csharp
private void PutSubject(CertRequestSubject Value)
```
...
| <code><a href="#@cdktf/provider-tls.certRequest.CertRequest.property.count">Count</a></code> | <code>double</code> | *No description.* |
...
```csharp
public CertRequestSubjectOutputReference Subject { get; }
```
...
```csharp
public CertRequestSubject SubjectInput { get; }
```
...
new CertRequestConfig {
    ...
    CertRequestSubject Subject = null,
    string[] Uris = null
};
```
...
| <code><a href="#@cdktf/provider-tls.certRequest.CertRequestConfig.property.count">Count</a></code> | <code>double</code> | *No description.* |
...
```csharp
public CertRequestSubject Subject { get; set; }
```
...
```csharp
public CertRequestSubject InternalValue { get; }
```
