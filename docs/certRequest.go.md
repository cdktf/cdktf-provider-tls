...
```go
import "github.com/cdktf/cdktf-provider-tls-go/tls/v5/certrequest"
...
```go
func PutSubject(value CertRequestSubject)
```
...
| <code><a href="#@cdktf/provider-tls.certRequest.CertRequest.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
```go
func Subject() CertRequestSubjectOutputReference
```
...
```go
func SubjectInput() CertRequestSubject
```
...
&certrequest.CertRequestConfig {
	...
	DnsNames: *[]*string,
	IpAddresses: *[]*string,
	Subject: github.com/cdktf/cdktf-provider-tls-go/tls/v5.certRequest.CertRequestSubject,
	Uris: *[]*string,
}
```
...
| <code><a href="#@cdktf/provider-tls.certRequest.CertRequestConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
```go
func InternalValue() CertRequestSubject
```
