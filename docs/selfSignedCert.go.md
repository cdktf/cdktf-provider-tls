...
```go
import "github.com/cdktf/cdktf-provider-tls-go/tls/v9/selfsignedcert"
...
&selfsignedcert.SelfSignedCertConfig {
	...
	Subject: github.com/cdktf/cdktf-provider-tls-go/tls/v9.selfSignedCert.SelfSignedCertSubject,
	Uris: *[]*string,
}
```
