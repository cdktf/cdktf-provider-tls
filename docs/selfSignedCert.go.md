...
```go
import "github.com/cdktf/cdktf-provider-tls-go/tls/v8/selfsignedcert"
...
&selfsignedcert.SelfSignedCertConfig {
	...
	Subject: github.com/cdktf/cdktf-provider-tls-go/tls/v8.selfSignedCert.SelfSignedCertSubject,
	Uris: *[]*string,
}
```
