...
```go
import "github.com/cdktf/cdktf-provider-tls-go/tls/v7/selfsignedcert"
...
&selfsignedcert.SelfSignedCertConfig {
	...
	Subject: github.com/cdktf/cdktf-provider-tls-go/tls/v7.selfSignedCert.SelfSignedCertSubject,
	Uris: *[]*string,
}
```
