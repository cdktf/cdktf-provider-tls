...
// https://registry.terraform.io/providers/hashicorp/tls/4.0.6/docs/resources/locally_signed_cert
...
export class LocallySignedCert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocallySignedCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.0.6/docs/resources/locally_signed_cert#import import section} in the documentation of this resource for the id to use
